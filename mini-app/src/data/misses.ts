    ...
    interview: [
      {
        question: 'Расскажи про планету, которая тебе досталась?',
        answer:
          'Мне досталась планета Нептун. Это самая далекая от солнца планета, которая, насколько я помню, продолжает отдаляться от солнца и выходит из солнечной системы. Но мне кажется, я вообще не такая, по крайней мере, я на это надеюсь.',
      },
      {
        question: 'Может быть, ты находишь общие черты ты со своей планетой?',
        answer:
          'Как я уже сказала, Нептун выходит из солнечной системы, и иногда у меня бывали моменты, когда я отдалялась от некоторых людей. Конечно, всем мил не будешь, и были в моей жизни моменты, когда я была таким «Нептуном». Это происходило уже после того, как я перешла на белорусский язык, и почти всегда из-за того, что я разговариваю по-белорусски. В таких случаях мама мне всегда говорила, что если ты не можешь изменить ситуацию, нужно изменить взгляд на нее.',
      },
      {
        question: 'У многих планет есть спутники, опиши твоего идеального спутника.',
        answer:
          'Ты знаешь, я отвечу на этот вопрос так: спутник способствует развитию планеты, поэтому мне кажется, что и в жизни спутник должен помогать планете, помогать раскрыть ей ее потенциал.',
      },
      {
