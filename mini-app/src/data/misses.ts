  ...
  },
  {
    ...
    interview: [
      ...
      },
      {
        ...
        answer:
          'Ты ведаеш, я адкажу на гэтае пытанне так: спадарожнік спрыяе развіццю планеты, таму мне здаецца, што і ў жыцці спадарожнік павінен дапамагаць планеце, дапамагаць раскрыць ёй яе патэнцыял.',
      },
      {
        question:
      ...
      },
      {
        ...
        answer:
          'Я ўвогуле не адчуваю час у ліцэі. Яно пралятае неверагодна хутка, і ты проста не паспяваеш за ім. Нагадваюць аб набліжэнні міскі толькі дэдлайны, якія я кожны дзень правяраю, каб не забыцца скінуць касцюм ці даслаць калаж. А што тычыцца "дня ікс": я спадзяюся, што будзе ўжо цёпла і што "Міс Ліцэй" стане для мяне адным з самых шчаслівых момантаў Ліцэя.',
      },
      {
