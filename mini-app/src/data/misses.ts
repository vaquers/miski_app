...
export const misses: Miss[] = [
  {
    ...
    interview: [
      ...
      },
      {
        ...
        answer: 'Говорят, что юпитер выглядит как яркая и ровно сияющая звезда. И я пытаюсь сделать все, чтобы когда я была на сцене - я наполняла зрителя своей энергетикой, сияла также сильно, как юпитер. И я думаю этим мы с ним похожи',
      },
      {
      ...
      },
      {
        ...
        answer: 'Да, я действительно принесла с собой тетрадку, но не думай, что она была прям большой. На самом деле это была моя опора, потому что у меня все запланировано и я всегда четко следую своему плану. Я действительно готовилась к отбору и невероятно хотела попасть не мероприятие, поэтому я боялась что-то забыть или упустить, но со своими записями я чувствовала себя уверенно и у меня отбор прошел хорошо. Как ты заметил, я люблю структурировать свои идеи, но не все в моей жизни распланировано и записано. Иногда и я люблю спонтанные идеи, а лучше всего у меня получается совмещать структуру и спонтанность',
      },
      {
        question: 'Расскажи про твое самое любимое мероприятие в лицее',
        answer: 'Наверное, мое любимое мероприятие в лицее - это Салют. Как только ты приходишь в лицей и видишь эту дружественную атмосферу, видишь всех этих людей, сидишь в круге на дискотеке, когда включают "Рэжым у самалёце", ты сразу понимаешь насколько здесь все сплоченные. Все так ярко и красочно! Это сразу очень привлекает и подкупает 10, которые только поступили сюда.',
      },
    ],
    theme: {
      background: '#0D0B1A',
  ...
  },
  {
    ...
    username: '@akkonding',
    className: '10 ИФ',
    instagramUrl: 'https://instagram.com/nastya_iv',
