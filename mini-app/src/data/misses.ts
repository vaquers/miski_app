  ...
  },
  {
    ...
    interview: [
      ...
      },
      {
        ...
        answer:
          'Ты ведаеш, я адкажу на гэтае пытанне так: спадарожнік спрыяе развіццю планеты, таму мне здаецца, што і ў жыцці спадарожнік павінен дапамагаць планеце, дапамагаць расчыніць ёй яе патэнцыял.',
      },
      {
        question:
        ...
        answer:
          'Часта людзі кажуць пра замежную мову, што я дасягну годнага ўзроўню мовы толькі калі я паеду ў Амерыку ці ў Англію і буду там размаўляць на англійскай мове з носьбітамі. І няма краіны лепш для практыкі беларускай мовы, чым Беларусь, таму я стараюся максімальна на ёй размаўляць тут. Але на самой справе я паліглот, і калі ты збіраешся вучыць новую мову, табе трэба задаць сабе пытанне: "А навошта мне вучыць новую мову?" І калі ты зразумееш, навошта табе вучыць мову, і паставіш сабе дакладную мэту, вучыць новыя мовы стане прасцей.',
      },
      {
        question:
        ...
        answer:
          'Я ўвогуле не адчуваю час у ліцэі. Яно пралятае неверагодна хутка, і ты проста не паспяваеш за ім. Нагадваюць аб набліжэнні міскі толькі дэдлайны, якія я кожны дзень правяраю, каб не забыцца скінуць касцюм ці даслаць калаж. У мяне ўжо з\'явіўся планёр для дэдлайнаў, але ён усё роўна мне не дапамагае. А што тычыцца "дня ікс": я спадзяюся, што будзе ўжо цёпла і што "Міс Ліцэй" стане для мяне адным з самых шчаслівых момантаў Ліцэя.',
      },
      {
        question: 'Раскажы анекдот, які табе спадабаўся.',
        answer:
          'Як вызначыць падлогу жывёлы? Бераце кацяняці, ставіце на падлогу і злёгку пляскаеце яго па попе, калі пабег, то гэта кот, а калі пабегла, то гэта котка.',
      },
    ],
    theme: {
      background: '#080A20',
