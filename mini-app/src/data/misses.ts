...
export const misses: Miss[] = [
  ...
  },
  {
    ...
    interview: [
      {
        question: 'Раскажы пра планету, якая табе дасталася?',
        answer:
          'Мне дасталася планета Няптун. Гэта самая далёкая ад сонца планета, якая, наколькі я памятаю, працягвае аддаляцца ад сонца і выходзіць з сонечнай сістэмы. Але мне здаецца, я ўвогуле не такая, прынамсі, я на гэта спадзяюся.',
      },
      {
        question: 'Можа быць, ты знаходзіш агульныя рысы ты са сваёй планетай?',
        answer:
          'Як я ўжо сказала, Няптун выходзіць з сонечнай сістэмы, і часам у мяне бывалі моманты, калі я аддалялася ад некаторых людзей. Вядома, усім мілы не будзеш, і былі ў маім жыцці моманты, калі я была такім «Няптуном». Гэта адбывалася ўжо пасля таго, як я перайшла на беларускую мову, і амаль заўсёды з-за таго, што я размаўляю па-беларуску. У такіх выпадках маці мне заўсёды казала, што калі ты не можаш змяніць сітуацыю, трэба змяніць погляд на яе.',
      },
      {
        question: 'У шматлікіх планет ёсць спадарожнікі, апішы твайго ідэальнага спадарожніка.',
        answer:
          'Ты ведаеш, я адкажу на гэтае пытанне так: спадарожнік спрыяе развіццю планеты, таму мне здаецца, што і ў жыцці спадарожнік павінен дапамагаць ёй раскрыць яе патэнцыял.',
      },
      {
        question:
          'Калі я з табой толькі пазнаёміўся, у мяне выклікала вялікую павагу тое, што ты размаўляеш і перапісваешся выключна на беларускай мове. Раскажы, як прапампаваць мову да такога ж ўзроўню.',
        answer:
          'Часта людзі кажуць пра замежную мову, што я дасягну годнага ўзроўню мовы толькі калі я паеду ў Амерыку ці ў Англію і буду там размаўляць на англійскай мове з носьбітамі. І няма краіны лепш для практыкі беларускай мовы, чым Беларусь, таму я стараюся максімальна на ёй размаўляць тут. Але насамрэч я паліглот, і калі ты збіраешся вучыць новую мову, табе трэба задаць сабе пытанне: "А навошта мне вучыць новую мову?" І калі ты зразумееш, навошта табе вучыць мову, і паставіш сабе дакладную мэту, вучыць новыя мовы стане прасцей.',
      },
      {
        question:
          'Ты прайшла ўжо вялізны шлях, і да міскі засталося не так шмат часу. Ці адчуваеш ты, што гадзіна ікс становіцца ўсё бліжэйшай, і што ты пры гэтым адчуваеш?',
        answer:
          'Я ўвогуле не адчуваю час у ліцэі. Ён пралятае неверагодна хутка, і ты проста не паспяваеш за ім. Нагадваюць аб набліжэнні міскі толькі дэдлайны, якія я кожны дзень правяраю, каб не забыцца скінуць касцюм ці даслаць калаж. А што тычыцца "дня ікс": я спадзяюся, што будзе ўжо цёпла і што "Міс Ліцэй" стане для мяне адным з самых шчаслівых момантаў Ліцэя.',
      },
      {
        question: 'Раскажы анекдот, які табе спадабаўся.',
        answer:
          'Як вызначыць пол жывёлы? Бераце кацяня, ставіце на падлогу і злёгку пляскаеце яго па попе, калі пабег, то гэта кот, а калі пабегла, то гэта котка.',
      },
    ],
    theme: {
      background: '#080A20',
    ...
    interview: [
      {
        question: 'Расскажи про планету, которая тебе досталась?',
        answer:
          'Моя планета — это Меркурий. Это самая маленькая в солнечной системе, но, по совместительству, самая близкая планета к солнцу. Ее назвали в честь древнеримского бога торговли, и поэтому она символизирует быстроту, ловкость, речь и письмо.',
      },
      {
        question: 'Какие общие черты ты находишь со своей планетой?',
        answer:
          'Во-первых, я посмотрела, что моя планета является уравнительной планетой для моего знака зодиака Девы, потому это уже какой-то знак. И вообще я нахожу сходства в том, что я тоже быстрая, ловкая, люблю общаться и быстро все решать.',
      },
      {
        question: 'У многих планет есть спутники. Опиши своего идеального спутника.',
        answer:
          'Я хочу сказать так: спутники, которые есть у планет, влияют на них своим гравитационным притяжением и тем самым влияют на скорость планеты, на ее курс. Поэтому, чтобы не сбиваться со своего курса, я предпочитаю спутников не иметь.',
      },
      {
        question: 'Есть ли у тебя дальнейшие амбиции на лицейскую сцену?',
        answer:
          'Они были, есть и будут. Пока у меня все силы забирает мисска, потом посмотрим, как все будет складываться. А желание выступать на сцене у меня появилось еще на салюте, так что я буду стараться пробовать себя во всем.',
      },
      {
        question: 'В каком фильме и вместо какого актёра ты бы снялась?',
        answer:
          'Наверное, мне бы хотелось сняться не в фильме, а в целой эпохе фильмов: в золотом веке Голливуда. Сейчас понятно, как снимают фильмы, а раньше все снималось на пленку, и хотелось бы сняться в чем-нибудь культовом. Если брать конкретный пример, то это «Унесенные ветром» за авторством Вивьена Ли. Мне нравится стилистика этого фильма, атмосфера середины 19 века, и мне очень импонирует книга, которая была взята за основу.',
      },
    ],
    theme: {
      background: '#0E0E18',
